...
const EventsIndex = () => {
	...
	function isButtonActive(eventID){
			...
			<Box className="main-box mar-t-24 grey-bg pad-b-50">
				...
				<ValidatorForm onSubmit={handleSubmitSearch} onError={() => null} className="search-form  rspd20" >
					<Grid container spacing={3} className="search-form-main">
						...
						<Grid item md={3} xs={12} className="search-form-block respo-w-100 d-flex respo-pad-t">
							<Grid>
				...
				<Grid container spacing={3} className="pt-20">
					...
					<Grid item md={12} className="event-list-right event-search-form respo-event-search-form " >
						...
						<div className={
									isButtonActive(0) ? 'button-active' : 'button-inactive'}
									onClick = { () => renderEvent(0)}
									>P0</div>
							<div
								className={
									isButtonActive(1) ? 'button-active' : 'button-inactive'}
								onClick = { () => renderEvent(1)}
								>P1</div>
							<div
								className={
									isButtonActive(2) ? 'button-active' : 'button-inactive'}
								onClick = { () => renderEvent(2)}
								>P2</div>
							<div
								className={
									isButtonActive(3) ? 'button-active' : 'button-inactive'}
								onClick = { () => renderEvent(3)}
								>Accident</div>
						</div>
							...
							<TableBody>
								<TableRow>
									...
									<TableCell className="event-cell">
										...
										<p className="event-p4"><b>Date & Time</b> : Dec 12, 2021 12:00 PM
										</p>

									</TableCell>
									<TableCell><Grid className="priority"><h6 className="event-h6">P1</h6></Grid></TableCell>
									<TableCell>
										<Grid container>
								...
								<TableRow>
									...
									<TableCell><Grid className="priority3"><h6 className="event-h6">P0</h6></Grid></TableCell>
									<TableCell><Grid container>
										<div className="progress1">100%</div>

										<span className="vertical-align-middle">
											<img src={CheckedBtn} className="check-btn" alt=""></img><p className="action-txt">Action completed</p></span>
									</Grid></TableCell>
								...
								<TableRow>
									...
									<TableCell><Grid className="priority2"><h6 className="event-h6">P0</h6></Grid></TableCell>
									<TableCell><Grid container>
								...
								<TableRow>
									...
									<TableCell><Grid className="priority4"><h6 className="event-h6">P1</h6></Grid></TableCell>
									<TableCell>
										<Grid container>
				...
				<Modal
					...
					className="modal-mega"
				>
					<Box container className="modal-event modal-border-radius modal-height event-action-width">						<Grid item>
							<Grid
								container
								className="action-event d-flx-new respo-actn"
							>
			...
			<Table>
				<TableHead>
					<TableRow className="event-h-row">
						<TableCell className="snap-cell">SNAP0</TableCell>
						<TableCell className="event-cell">EVENTS</TableCell>
	...
	return (
		<>
			<Table>
				<TableHead>
					<TableRow className="event-h-row">
						<TableCell className="snap-cell">SNAP1</TableCell>
						<TableCell className="event-cell">EVENTS</TableCell>
	...
	return (
		<>
			<Table>
				<TableHead>
					<TableRow className="event-h-row">
						<TableCell className="snap-cell">SNAP2</TableCell>
						<TableCell className="event-cell">EVENTS</TableCell>
	...
	return (
		<>
			<Table>
				<TableHead>
					<TableRow className="event-h-row">
						<TableCell className="snap-cell">SNAP3</TableCell>
						<TableCell className="event-cell">EVENTS</TableCell>
