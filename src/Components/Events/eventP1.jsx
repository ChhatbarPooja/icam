                                ...
                                <TableRow>
                                    ...
                                    <TableCell>
                                        <Grid container>
                                            <div className="progress1">100%</div>
                                            <span className="vertical-align-middle">
                                                <img src={CheckedBtn} className="check-btn"></img><p className="action-txt">Action completed</p>
                                            </span>
                                        </Grid>
                                    </TableCell>
                                    <TableCell className="text-center"><Switch checked uncheckedIcon checkedIcon /></TableCell>
                    ...
                    <Box container>
                        <Grid container spacing={4} className="pl-20">
                            <Grid item md={4} xs={10} className="snap-form pl-20">
                                <h4 className="snap-h">
                                    SNAP PREVIEW<img src={CloseBtn} className="snap-close pointer" onClick={handleClose} />
                                </h4>
