            ...
            <Box className="main-box mar-t-24 grey-bg pad-b-50">
                <Grid container spacing={3} className="main-grid">
                    <Grid item md={6} className="main-title">
                        <h4>Add Event Designer</h4>
                    </Grid>
                    <Grid item md={6} className="breadcrumb">
                        <h6><span className="pointer" onClick={() => navigate('/dashboard')}>Home /</span><span className="pointer" onClick={() => navigate("/event_designer")}> Event Designer /</span> Add Event Designer </h6>
                    </Grid>
                                            ...
                                            <Grid container spacing={3} className="search-form-main respo-pad-0-20">
                                                <Grid item md={6} className="user-add-block">
                                                    ...
                                                    <TextField
                                                        ...
                                                        name="e_workflow"
                                                        id="e_workflow"
                                                        label="Enter event workflow"
                                                        placeholder="Enter event workflow"
                    ...
                    <Grid container spacing={4}>
                        ...
                        <Grid item md={4} xs={8} className="snap-form pl-5 pd-btm">
                            ...
                            <Grid  container md={12} xs={12}>
                                <ValidatorForm onSubmit={handleSubmitSearch} onError={() => null} className="frm-cs">

                                    
                                    <Grid container md={12} xs={12} className="flx-2-prt">
                                    <label className="discard-txt">Event step name</label>
                                        <TextField
                                            className="discard-custom-input fix-width width-100"
                                            id="size-small"
                                            size="small"
                                        ...
                                        <Grid container md={12} xs={12} className="flx-2-prt">    
                                        <label className="discard-txt top-pad">Description</label>
                                        <TextField
                                    ...
                                    <Grid
                                        ...
                                        alignItems="left"
                                    >
                                        <label className="radio-txt radio-btn-txt mt-3">Event PDF Required</label>
                                        <Grid container className="mt-10 pt-15">
                                            <RadioGroup name="nameRadio" className="escalate-radio mt-10 mid-radio">
                                                <div className="">
                                                    <Radio className="radio-spc" value="active" checked={selected === 'yes'} />Yes
                                                </div>
...
export default AddEventDesigner;
