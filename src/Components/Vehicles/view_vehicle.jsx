...
import {vehicleView} from "../../Services/api"
import {getDataFromApi} from "../../Services/CommonServices"
import { useParams } from 'react-router-dom'
import {gender_opt,country_opt,state_opt,manage_opt} from '../commoncomponent/CommonObject'

const VehiclesView=() => {
    const navigate = useNavigate()
    let { vehicleid } = useParams()
    const [formdata, setFormData] = useState({ id: "", device_id: "", device_name: "", device_name: "", driver_id: "", driver_name: "", manufacturer_by: "", model_name: "", model_number: "", storage: "", vehicle: "", vehicle_number: "", nameRadio: "ACTIVE", description: "" })
